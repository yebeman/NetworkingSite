...
// bar for the message box
 $html.="<div align='center' style='display: block; margin-top:15px; background-color:#ccc;'>";
  $html.="
   <div style='width:900px; display: inline-block; vertical-align: top; background-color:#999999;  height:320px;'>
...
<div  style=' display: block; width:900px; margin-left:auto; margin-right:auto;  margin-top:75px;'>";
         ...
         $pages =$prof["profileInfo"];
         $pages = explode("|s|", $pages);
         $html.= '<div id="navlist"   style=" width:950px;  margin: 0 auto;">';
         $html1='<div  style=" width:450px; display: inline-block; vertical-align: top;word-wrap: break-word;white-space: normal;">';
		 $html2='<div style="margin-left:20px; width:450px; display: inline-block; vertical-align: top;white-space: normal;">';
		...
		if($x%2!=0)
         ...
         ${'html'.$var1}.= '<table id="profileT'.$x.'" class="backBox" style="background:#eaeaea;" cellspacing="0"  cellpadding="0">';
		
		 $first=true;
         for($y=0;$y<(count($pieces));$y++) {// inside the title
         
         ${'html'.$var1}.= '<tr valign="top"  align="left" ';
         
         
          if($x==(count($pages)-1)){
		 
		 ${'html'.$var1}.= '><td><br><p style=" padding-left:15px;"><input type="text" class="checkout-input checkout-name" placeholder="Add Title" onKeyUp="submitBtn('.$x.')"  title="Make your own Profile"  id="'.$x.$y.'" required x-moz-errormessage="Make your own Profile" ><br><tr valign="top"   align="left"> <td></p>';//for the create your own prof
		  } 
         else if($y==0)
         {	
         ${'html'.$var1}.= 'height="0px"><td style="border-right:solid 2px #FAA101;"><br><font color="#666666" face="Arial" style=" padding-left:15px; font-size:20px;" >'. $pieces[$y].'</font><br><br><tr valign="top" align="left"> <td>';}

         else {
         ${'html'.$var1}.=  'bgcolor="#f5f5f5"  > <td><p style=" padding-left:15px;padding-right:15px;">
         <font color="#555555" face="Arial" id="T'.$x.$y.'" size="4">'. $pieces[$y].'</font><br>
         
		 <span class="text-content" style="color:#888888;" id="'.$x.$y.'">'.$prof[$pieces[++$y]].'</span>
		 
		 
         
         &nbsp;&nbsp;&nbsp;&nbsp;
        
         <select id="'.$x.$y.'" onChange="submitBtn('.$x.')"> <option value="'.$pieces[++$y].'">'.$pieces[$y].'</option>';
