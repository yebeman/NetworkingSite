        ...
        <div id='sticky_navigation'>
            <div class='demo_container'>
                <ul>
                    ...
                    <li><a class='selected' href='#'>Photo</a>
                    </li>
...
<div  style=' display: block; width:900px; margin-left:auto; margin-right:auto;  margin-top:75px;'>";
  ...
  <ul class="parrent" id="grid">';
	...
	$album = $_REQUEST ['album']; // "Work Hard";//$_POST['emailAddress'];
	$uid = 12; // $_POST['emailAddress'];
	...
	if (isset ( $result_array )) {
		foreach ( $result_array as $result ) {
			$html .= '<li class="viewport"><a  href="' . $result ['http'] . '" data-lightbox="example-set" desc="' . $result ['desc'] . '" like="' . $result ['likes'] . '" cmt="' . $result ['noCmts'] . '"  view="' . $result ['seen'] . '"><span class="dark-background">' . $result ['desc'] . '</span><img src="' . $result ['http'] . '" >

		</a>
		<ul class="child">

		<li class="cmts"><a title="comment" href="' . $result ['http'] . '" data-lightbox="0002" desc="' . $result ['desc'] . '" like="' . $result ['likes'] . '" cmt="' . $result ['noCmts'] . '"  view="' . $result ['seen'] . '">' . $result ['noCmts'] . '</a></li>
		<li class="likes"><a title="Like" href="/shots/1122381-Sunshine-Rebound/fans">' . $result ['likes'] . '</a></li>
		<li class="views">' . $result ['seen'] . '</li>
		</ul></li>';
		}
	}
	
	// msg
	$html .= "</div></div><div  id='onlineF' style=' top:35px;position: fixed; float: right; right: 2%;'>
