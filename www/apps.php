...
";
  $html.="<div   align='left' class='panel'><img style='float: left;width:200px; height:200px; padding: 2px; background: #888888'  src='".$display_pic."'/>";
  $html.="<p style=' word-wrap:break-word ;'><br>".$display_name."</p></div>";
  $html.="<a class='trigger'  href='#'><img style='float: left; padding: 2px; background: #888888'  id='icon' height='40px' width='40px' src=".$display_pic." alt='Profile Picture'/>";
  $html.="<div style=' float:left; padding-top:13px;padding-bottom:10px;'> &nbsp;".$display_name."&nbsp;</div></a> </div>";
  //header
...
<ul>                
 ...
 //
  ...
  <h3>Your pages</h3>
  ".$pagesI."
   <button class='multBtn' style='position:absolute;margin-left:210px; bottom:0px;' id='showLeftPush'> Apps</button> </nav>	
